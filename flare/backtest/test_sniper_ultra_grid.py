"""
flare.backtest.test_sniper_ultra_grid

Mode 1.1 (FLARE-Sniper-Pure, 4h)에 대해
익절 TP [12, 15, 18]% x 손절 SL [12, 15, 18]%
총 9개 조합 2D 그리드 서치 백테스트 및 성과 매트릭스 산출 모듈
"""
...
def main():
    ...
    tp_levels = [12.0, 15.0, 18.0]
    sl_levels = [12.0, 15.0, 18.0]
    
    records = []
    
    print("=" * 115)
    print("🔬 [Mode 1.1: FLARE-Sniper-Pure (4h)] TP x SL [12, 15, 18]% (3x3 = 9개 조합) 그리드 서치 실행")
    print("=" * 115)
