"""
flare.backtest.test_sniper_wide_grid

Mode 1.1 (FLARE-Sniper-Pure, 4h)에 대해
익절 TP [3, 5, 7, 9]% x 손절 SL [3, 5, 7, 9]%
...
def main():
    ...
    tp_levels = [3.0, 5.0, 7.0, 9.0]
    sl_levels = [3.0, 5.0, 7.0, 9.0]
    
    records = []
    
    print("=" * 115)
    print("🔬 [Mode 1.1: FLARE-Sniper-Pure (4h)] TP x SL [3,5,7,9]% (4x4 = 16개 조합) 그리드 서치 실행")
    print("=" * 115)
